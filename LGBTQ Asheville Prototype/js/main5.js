const mapEast = new mapboxgl.Map({
container: 'mapEast', // container ID
style: 'mapbox://styles/ajjolly/cl334dosp001w15pdla8beje4', // style URL
center: [-82.534, 35.575], // starting position [lng, lat]
...
mapEast.scrollZoom.disable();

/*Navigation Controls*/
mapEast.addControl(new mapboxgl.NavigationControl());
