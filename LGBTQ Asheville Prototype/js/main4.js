const mapWest = new mapboxgl.Map({
container: 'mapWest', // container ID
style: 'mapbox://styles/ajjolly/cl334dosp001w15pdla8beje4', // style URL
center: [-82.593, 35.579], // starting position [lng, lat]
...
mapWest.scrollZoom.disable();

/*Navigation Controls*/
mapWest.addControl(new mapboxgl.NavigationControl());
